...
async function getSingleCart(n) {
...
async function getTotalProducts(n) {
  const res = await axios.get(`${BASE_URL}/carts/${n}`);
  const data = res["data"];
...
async function getProductList(n) {
  const res = await axios.get(`${BASE_URL}/carts/${n}`);
  const data = res["data"];
...
async function getProductName(n, propertyName) {
  const res = await axios.get(`${BASE_URL}/carts/${n}`);
  const data = res["data"];
